...
const eslintConfig = [
	{
		ignores: [
			...
			"dist/", // Ignore common build output folder
			"public/", // Ignore public assets folder (optional, depending on your project)
			"*.config.js", // You might want to ignore eslint config itself or other config files
			"*.config.mjs",
			"*.config.cjs",
			"lib/generated/**/*",
		],
